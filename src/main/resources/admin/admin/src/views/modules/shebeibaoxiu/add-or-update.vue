    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="损坏情况" prop="sunhuaiqingkuang">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="损坏情况"
                  v-model="ruleForm.sunhuaiqingkuang" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.sunhuaiqingkuang" label="损坏情况" prop="sunhuaiqingkuang">
                    <span>{{ruleForm.sunhuaiqingkuang}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeileixing = true;
          ...
          if(o=='sunhuaiqingkuang'){
            this.ruleForm.sunhuaiqingkuang = obj[o];
	    this.ro.sunhuaiqingkuang = true;
            continue;
          }
          if(o=='baoxiuneirong'){
