<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="润滑部位" prop="runhuabuwei">
          <el-input v-model="ruleForm.runhuabuwei" 
              placeholder="润滑部位" clearable  :readonly="ro.runhuabuwei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="润滑部位" prop="runhuabuwei">
              <el-input v-model="ruleForm.runhuabuwei" 
                placeholder="润滑部位" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="润滑油种类" prop="runhuayouzhonglei">
          <el-input v-model="ruleForm.runhuayouzhonglei" 
              placeholder="润滑油种类" clearable  :readonly="ro.runhuayouzhonglei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="润滑油种类" prop="runhuayouzhonglei">
              <el-input v-model="ruleForm.runhuayouzhonglei" 
                placeholder="润滑油种类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="加油量" prop="jiayouliang">
          <el-input v-model="ruleForm.jiayouliang" 
              placeholder="加油量" clearable  :readonly="ro.jiayouliang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="加油量" prop="jiayouliang">
              <el-input v-model="ruleForm.jiayouliang" 
                placeholder="加油量" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="润滑周期" prop="runhuazhouqi">
          <el-input v-model="ruleForm.runhuazhouqi" 
              placeholder="润滑周期" clearable  :readonly="ro.runhuazhouqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="润滑周期" prop="runhuazhouqi">
              <el-input v-model="ruleForm.runhuazhouqi" 
                placeholder="润滑周期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shebeileixing = true;
          ...
          if(o=='runhuabuwei'){
            this.ruleForm.runhuabuwei = obj[o];
	    this.ro.runhuabuwei = true;
            continue;
          }
          if(o=='runhuayouzhonglei'){
            this.ruleForm.runhuayouzhonglei = obj[o];
	    this.ro.runhuayouzhonglei = true;
            continue;
          }
          if(o=='jiayouliang'){
            this.ruleForm.jiayouliang = obj[o];
	    this.ro.jiayouliang = true;
            continue;
          }
          if(o=='runhuazhouqi'){
            this.ruleForm.runhuazhouqi = obj[o];
	    this.ro.runhuazhouqi = true;
            continue;
          }
          if(o=='gonghao'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `shebeirunhua/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.shebeirunhuaCrossAddOrUpdateFlag = false;
                  this.parent.search();
