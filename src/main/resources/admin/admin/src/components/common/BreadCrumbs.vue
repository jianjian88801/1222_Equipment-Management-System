<template>
  <el-breadcrumb class="app-breadcrumb" separator="/" style="height:50px;backgroundColor:rgba(245, 247, 250, 1);borderRadius:4px;padding:20px 0px 20px 0px;boxShadow:0px 0px 0px #f903d4;borderWidth:0px;borderStyle:dotted solid double dashed;borderColor:#ff0000;">
    ...
    breadcrumbStyleChange(val) {
      this.$nextTick(()=>{
        ...
        document.querySelectorAll('.app-breadcrumb .el-breadcrumb__inner .no-redirect').forEach(el=>{
          el.style.color = "rgba(0, 85, 255, 1)"
        })
